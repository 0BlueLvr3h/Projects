document.addEventListener("DOMContentLoaded", () => {
    ...
    var AGVObj = new AGV(elem,homeNode);
    ...
    document.getElementById("changeButton").addEventListener("click", () => {
        ...
        writeNodes(nodePath,nodeCoordPair,AGVObj.graphicElement,ctx,AGVObj.homePosition);
    });
    writeNodes(nodePath,nodeCoordPair,AGVObj.graphicElement,ctx,AGVObj.homePosition);
    ...
    document.getElementById("animation").addEventListener("click", () => {
        ...
        nodePath.forEach(function (node, i) { if (node.isThisNodeHome()) { homeNodeIndex = i; } });
        var finalDestinationNumbers = dijkstra(homeNodeIndex - 1, document.getElementById("destinationNode").value);
